 ...
 */
public class ReadyHomework extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_ready_homework, container, false);
    }
    @Override
    public void onStart(){
        super.onStart();
    ...
    public void onClick(View view){
        switch (view.getId()){
            case R.id.fm_ready_homework_com:
                hideAndshow(0);
                break;
            case R.id.fm_ready_homework_not_com:
                hideAndshow(1);
                break;
        }
    }
    ...
    public void initFragment(){
        ...
        fragmentTransaction.add(R.id.fm_ready_homework_framelayout,fragmentList.get(0));
        fragmentTransaction.add(R.id.fm_ready_homework_framelayout,fragmentList.get(1));
        fragmentTransaction.commit();
    }
    //初始化界面的组件
    public void initView(){
        com = (TextView) getActivity().findViewById(R.id.fm_ready_homework_com);
        not_com = (TextView) getActivity().findViewById(R.id.fm_ready_homework_not_com);
