...
public class SquareMenu extends View {
    ...
    private static final int FAB_ICON_PADDING = 8;
    ...
    private Paint paintFAB, paintFabBG, paintFabBGWidShadow, paintFabBGWithoutShadow, paintFabPlus, paintIcons,mpaintFAB;
    ...
    private void setupPaint() {
        ...
        mpaintFAB = new Paint();
        mpaintFAB.setStyle(Paint.Style.FILL);
        mpaintFAB.setColor(Color.GRAY);
        mpaintFAB.setShadowLayer(0, 0, 0, Color.BLACK);
        // Important for certain APIs
        setLayerType(LAYER_TYPE_SOFTWARE, mpaintFAB);

        paintFabBGWidShadow = new Paint();
        paintFabBGWidShadow.setStyle(Paint.Style.FILL);
        paintFabBGWidShadow.setColor(Color.WHITE);
        paintFabBGWidShadow.setShadowLayer(0, 0, 0, Color.BLACK);
        ...
        paintFabPlus.setColor(Color.GRAY);
    ...
    private void startAnimationTopRightMenu() {
        ...
        paintFAB.setShadowLayer(2,0,0,Color.GRAY);
